# -*- coding: utf-8 -*-
"""
Probability data processing
Created on Wed Apr  8 08:57:53 2020
...
#%%
dataset = pd.read_csv("C:/Users/eacru/OneDrive/Documents/Ferguson lab data/Probability discounting/OFC nonspecific/OFC nonspecific_processed.csv")
dataset['Box'] = 0
dataset['Subject']=0
#%%
...
#%%
def RiskyLeverPosition(dataset):
    #groupby subject
...
#%% 
        #export to csv
rootdir = 'C:/Users/eacru/OneDrive/Documents/Ferguson lab data/Probability discounting/OFC nonspecific'
def ExportProcessedProbabilityExperimentData(dataset,rootdir, experiment):
